...
export default function Navbar() {
    ...
    return (
            <div className={`gridLayout lg:grid mx- flex justify-center w-full max-w-[1920px] hoverTransition z-50 fixed ${isScrolled ? "lg:top-[0px] top-[20px]" : "lg:top-[20px] top-[60px]"}`}>
