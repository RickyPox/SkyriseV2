    ...
    return(
        <div>
            <div className='gridLayout grid relative'>
                ...
                className="col-start-2 col-span-6 lg:col-start-3 lg:col-span-4 2xl:col-start-4 2xl:col-span-3 text-center mt-[35px]">Our Work</motion.h1>
                <motion.p 
                ref={title} 
                initial={{ opacity:0, }}
                animate={ titleInView? { opacity:1,  } : {}} 
                ...
                className="col-start-1 col-span-full 425:col-start-2 425:col-span-6 lg:col-start-3 lg:col-span-4 2xl:col-start-4 2xl:col-span-3 text-center">
                    A curated collection of our accomplishments, showcasing our expertise and dedication to delivering exceptional results.
                    </motion.p>
                    <PlusSign/>
