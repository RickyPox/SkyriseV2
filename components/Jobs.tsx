        ...
        <div>
            ...
            className="gridLayout grid pt-[50px] sm:pt-[80px] 2xl:pt-[100px]">
                ...
                transition={{ duration:0.5 }} className="col-span-full flex 2xl:flex-row flex-col items-center justify-center gap-[20px]">
                    {joblist.map((job, i)=>(
                        <div key={i}  onMouseEnter={() => handleMouseEnter(i)} onMouseLeave={handleMouseLeave} className={`relative p-[30px] 1920:w-1/3 w-full max-w-[700px] min-h-[220px] h-full justify-between border-[#FFFFFF] border-[1px] flex flex-col`}>
                            <div>
