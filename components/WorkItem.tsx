...
export default function WorkItem(props:any){
    ...
    return(
        ...
        onMouseEnter={handleHover} onMouseLeave={handleHover} className={`relative col-span-full lg:col-span-4 2xl:col-span-3 flex items-center justify-center h-[210px] lg:h-[270px] 2xl:h-[175px] lg: border-[#FFFFFF] border-[1px]`}>
