...
export default function Button (props:any){
    ...
    return(
        ...
        <p className={`hoverTransition ${isHover ? "text-[#050505]" : ""}`}>{props.title}</p>
        <div className="flex items-center">
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path className="hoverTransition" d="M0.876036 15L0 14.124L12.8271 1.27243H1.00325V0H15V13.9967H13.7275V2.17293L0.876036 15Z" fill={props.color ? `${isHover ? "#050505 " : props.color}` : `${isHover ? "#050505" : "#FDFDFD"}`}/>
            </svg>
        </div>
